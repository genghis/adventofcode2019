...
# inputlist = [3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99]
opcode_position = 0
inputcode = 5
...
def opcode5(num1, num2):
	global opcode_position

	if num1 != 0:
		opcode_position = num2
	else:
		opcode_position += 3

def opcode6(num1, num2):
	global opcode_position
...
def opcode7(num1, num2, num3):
	if num1 < num2:
		inputlist[num3] = 1
	else:
		inputlist[num3] = 0

def opcode8(num1, num2, num3):
	if num1 == num2:
		inputlist[num3] = 1
	else:
		inputlist[num3] = 0
...
while True:
	if inputlist[opcode_position] == 1:
		...
		opcode_position += 2
	elif inputlist[opcode_position] == 5:
		firstnumber = inputlist[(opcode_position+1)]
		secondnumber = inputlist[(opcode_position+2)]
		opcode5(inputlist[firstnumber],inputlist[secondnumber])
	elif inputlist[opcode_position] == 6:
		firstnumber = inputlist[(opcode_position+1)]
		secondnumber = inputlist[(opcode_position+2)]
		opcode6(inputlist[firstnumber],inputlist[secondnumber])
	elif inputlist[opcode_position] == 7:
		firstnumber = inputlist[(opcode_position+1)]
		secondnumber = inputlist[(opcode_position+2)]
		thirdnumber = inputlist[(opcode_position+3)]
		opcode7(inputlist[firstnumber], inputlist[secondnumber], thirdnumber)
		opcode_position += 4
	elif inputlist[opcode_position] == 8:
		firstnumber = inputlist[(opcode_position+1)]
		secondnumber = inputlist[(opcode_position+2)]
		thirdnumber = inputlist[(opcode_position+3)]
		opcode8(inputlist[firstnumber], inputlist[secondnumber], thirdnumber)
		opcode_position += 4
	else:
		...
		if strung_num[-2:] == "01":
			...
			if stringlength >= 3:
				if strung_num[-3] == "1":
					...
					print("FUCKED UP ON PARAMETERIZED CODE 5")
			else:
				index = inputlist[(opcode_position+1)]
				firstnumber = inputlist[index]
			...
			opcode5(firstnumber,secondnumber)

		elif strung_num[-2:] == "06":
			if stringlength >= 3:
				if strung_num[-3] == "1":
					firstnumber = inputlist[(opcode_position+1)]
				elif strung_num[-3] == "0":
					...
					print("FUCKED UP ON PARAMETERIZED CODE 6")
			else:
				index = inputlist[(opcode_position+1)]
				firstnumber = inputlist[index]
			...
			opcode6(firstnumber,secondnumber)

		elif strung_num[-2:] == "07":
			if stringlength >= 3: 
				if strung_num[-3] == "1":
					firstnumber = inputlist[(opcode_position+1)]
				elif strung_num[-3] == "0":
					...
					print("FUCKED UP ON PARAMETERIZED CODE 7")
			else:
				index = inputlist[(opcode_position+1)]
				firstnumber = inputlist[index]
			...
			opcode7(firstnumber, secondnumber, thirdnumber)
			opcode_position += 4
		
		elif strung_num[-2:] == "08":
			if stringlength >= 3: 
				if strung_num[-3] == "1":
					firstnumber = inputlist[(opcode_position+1)]
				elif strung_num[-3] == "0":
					...
					print("FUCKED UP ON PARAMETERIZED CODE 8")
			else:
				index = inputlist[(opcode_position+1)]
				firstnumber = inputlist[index]
			...
			opcode8(firstnumber, secondnumber, thirdnumber)
			opcode_position += 4
